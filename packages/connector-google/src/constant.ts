...
export const defaultMetadata: ConnectorMetadata = {
  ...
  description: {
    ...
    'tr-TR': 'Google, en büyük arama motoru teknolojisi ve e-posta servis sağlayıcısıdır.', // Update REQUIRED
    'ko-KR': 'Google은 가장 큰 검색 엔진 기술과 이메일 서비스 제공자입니다.', // Update REQUIRED
  },
  readme: './README.md',
